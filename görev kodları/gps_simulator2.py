...
# Hedef koordinat
TARGET_LAT = 40.7710894  # Mission Planner hedef
TARGET_LON = 29.4372419  # Mission Planner hedef

# Simüle GPS (test için)
SIMULATE_GPS = True   # True = sahte GPS kullan, False = gerçek GPS
sim_lat = 40.7710800    # Başlangıç koordinatı (hedefe yakın)
sim_lon = 29.4372419
